...
// Holds the 3D canvas where the loaded image is displayed
{
  ...
  // A shiny blue sphere located at (0,4,0)
  {
    ...
    Color3f blue = new Color3f(255.f, 0.0f, 0.0f);
    Color3f specular = new Color3f(0.0f, 0.0f, 0.39f);

    Material blueMat= new Material(blue, black, blue, specular, 0.0f);
    ...
    Material specularMat= new Material(specular, black, specular, specular, 25.0f);
       // sets ambient, emissive, diffuse, specular, shininess
    specularMat.setLightingEnable(true);

    Appearance specularApp = new Appearance();
    specularApp.setMaterial(specularMat);
    
    
    
    // position the sphere
    Transform3D t3d = new Transform3D();
    t3d.set( new Vector3f(0,5,0)); 
    TransformGroup tg = new TransformGroup(t3d);
    tg.addChild(new Cylinder(1.0f,4.0f, blueApp));   // set its radius and appearance
 
    
    Transform3D t3d1 = new Transform3D();
    t3d1.set( new Vector3f(0,2,0)); 
    TransformGroup tg1 = new TransformGroup(t3d1);
    tg1.addChild(new Cone(1.0f,-2.0f,specularApp));   // set its radius and appearance


    Transform3D t3d2 = new Transform3D();
    t3d2.set( new Vector3f(5,20,0)); 
    TransformGroup tg2 = new TransformGroup(t3d2);
    tg2.addChild(new Cone(3.0f,-5.0f,specularApp));   // set its radius and appearance
